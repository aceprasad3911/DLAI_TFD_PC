...
train_dataset = tf.keras.utils.image_dataset_from_directory( # Point at folders and automatically create labelled dataset
    train_dir, # Automatically labels images if placed in correct folder directory
    image_size=(150, 150),
    batch_size=20,
    label_mode='binary'
    )
...
# Cache, shuffle & preset to get data into its final form
